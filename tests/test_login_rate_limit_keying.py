...
def _enable_limiter():
    ...
    The session-scoped _disable_rate_limiter autouse fixture sets
    limiter.enabled = False to prevent test-suite registrations from hitting
    the ceiling.  Tests here opt in by declaring this fixture.
    """
...
def test_different_emails_have_separate_rate_limits(_enable_limiter):
...
def test_same_email_shares_rate_limit_across_clients(_enable_limiter):
